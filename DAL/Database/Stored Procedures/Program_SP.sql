...
BEGIN
	...
	STATE = @STATE,
	UNIT = @UNIT
	WHERE PROGRAM_ID = @ID AND PROGRAM_ID != 1; 
END;
GO
...
BEGIN
	SELECT P.PROGRAM_ID,P.NAME,P.STATE,P.UNIT
	FROM PROGRAM P
	WHERE P.STATE = 1 AND P.PROGRAM_ID != 1 AND
	DELETED = 1;
END;
GO
...
BEGIN
	SELECT P.PROGRAM_ID,P.NAME,P.STATE,P.UNIT
	FROM PROGRAM P
	WHERE P.STATE = 0 AND P.PROGRAM_ID != 1 AND
	DELETED = 1;
END;
GO


INSERT INTO PROGRAM (PROGRAM_ID,NAME,STATE,UNIT, DELETED) VALUES (1,'General',1,'000000', 1);
