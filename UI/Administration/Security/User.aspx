<%@ Page Title="" Language="C#" MasterPageFile="~/Administration/Administration.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="UI.Administration.Security.User" %>
                    ...
                    <section class="form row">
                        ...
                        <section class="col-md-6">
                            ...
                            <section class="form-group">
                                ...
                                <span class="message-has-error"><asp:Label runat="server" ID="lblMessagePassword"></asp:Label></span>
                            </section>
                            <section class="form-group">
                                <asp:Label ID="lblConfirmPassword"  Text="Confirmar Contraseña:" runat="server"></asp:Label>
