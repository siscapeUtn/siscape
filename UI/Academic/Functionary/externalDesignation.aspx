            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <section class="form row create">
                        ...
                        <section class="col-md-6">
                            ...
                            <section class="form-group">
                                ...
                                <asp:TextBox ID="txtHoursDisignation" CssClass="form-control" runat="server"  placeholder="Digite multiplos de 5..."></asp:TextBox>
                                <asp:Label CssClass="message-has-error" runat="server"></asp:Label>
                            </section>
                        </section>
                    ...
                    <section class="dataExists">
                        <section class="table-responsive">
                            <asp:GridView ID="gvExternalDesignation" runat="server" AutoGenerateColumns="False" >
                                <Columns>
